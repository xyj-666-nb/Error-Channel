...
public class PlayerManager : MonoBehaviour
{
    ...
    public List<int> GetStrengthenReultList = new List<int>() { 5, 20, 30, 50, 60 };
    ...
    public void AddGameLevel()
    {
        ...
        else if (CurrentLevel == GameLevel.Level5)
        {
            ...
            UImanager.Instance.GetPanel<televisionPanel>().ControlCheckRuleButton(true);
        }
    ...
    public void ReFreshCardNumber()
    {
        ...
        // 重新初始化所有卡牌（InitCard内部会调用GetEnemyCard）
